...
| File | Purpose |
|------|---------|
| `catalog.yaml` | Master registry for all 73 skills and 54 agents. Contains category, spec path, and last-test tracking fields. Always read this first when running any test command. |
...
babylon     → babylon-js-specialist, babylon-shader-specialist,
              babylon-ui-specialist, babylon-physics-specialist,
              babylon-webxr-specialist

...
| **concept 层**(3 条) | `TR-concept-003/004`(MVP 8 条 / P0 排除项)+ `TR-concept-006`(帧预算) | 范围声明类,**倾向显式降级为「不需 ADR」** —— 待用户裁定 |
...
| `concept` | (跨系统范围声明) | — | 8 | 5 | 0 | 3 | technical-preferences · 用户裁定 |
...
| **`concept` 组的 3 条**(`TR-concept-003/004/006`)| 纯范围声明(MVP 8 条 / P0 排除项 / 帧预算)——
**须用户裁定是否降级为「不需 ADR」**。**本文件不代裁。** |
...
| **QQ-07** | **`concept` 组 3 条范围声明是否降级为「不需 ADR」** | 🟡 | **用户裁定** |

...
> **Last Updated**: 2026-09-15(ADR-015 落盘后同步)
...
| `random-events.md` | 52 随机事件导演 | 31 | 9 | 2 | 20 |
| `disease-simulation.md` | 9 疾病与伤情 | 22 | **17** | **2** | 3 |
| `diagnosis-system.md` | 8 诊断与体征 | 20 | 4 | 5 | 11 |
...
## 3. 随机事件导演 `design/gdd/random-events.md`(#52)| 31 条
...
| TR-randomevents-024 | 事件与 51 遥测的边界 | — | ❌ |
| TR-randomevents-025 | 事件文本的本地化载体 | — | ❌ |
| TR-randomevents-026 | 联机语义:多人共享同一事件 | — | ❌ |
| TR-randomevents-027 | 与 29 死亡复活的交互 | — | ❌ |
| TR-randomevents-028 | 与 13 病人 AI 的交互 | — | ❌ |
| TR-randomevents-029 | **27 敌人 AI 不被事件导演锁定** | — | ❌ **NO-ADR** |
...
## 5. 诊断与体征 `design/gdd/diagnosis-system.md`(#8)| 20 条
...
| TR-diag-020 | 脉案 DTO 的静态检查 | ADR-013 | ⚠️ 机制定:递归反射扫描 `PresentationDtoGuard`;待 39 DTO 定稿 |
...
>    残留:R-11(是否 DOTS)· R-14(AI 架构;导航格来源已由 ADR-015 定型,寻路形态待定)。
